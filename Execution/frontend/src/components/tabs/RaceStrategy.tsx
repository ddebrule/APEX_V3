      ...
      <div className="w-[380px] bg-[#0d0d0f] border-r border-white/5 flex flex-col z-50 transition-transform">
        ...
        <div className="p-[30px] flex-1 overflow-y-auto space-y-5">
          ...
          <div>
            ...
            <div className="bg-black border border-white/5 p-2 text-base text-[#999] font-mono rounded rounded">
          ...
          {/* Racer Display */}
          <div>
            <label className="text-sm font-extrabold text-[#555] uppercase block mb-2">Racer</label>
            <div className="bg-black border border-white/5 p-2 text-base text-[#999] font-mono rounded">
              {selectedRacer?.name || '—'}
            </div>
          </div>
          ...
          <button
            ...
            className={`w-full border font-black uppercase text-base p-2.5 rounded tracking-wider transition-all mt-5 ${
        ...
        <div className="bg-[#121214] border border-white/5 rounded flex flex-col overflow-hidden shrink-0">
          ...
          <div className="p-5 space-y-3">
            ...
            <input
              ...
              className={`w-full bg-black border rounded px-3 py-2 text-base font-mono focus:outline-none transition-colors ${
